...
\lhead{}
\chead{}
\rhead{\includegraphics[width=8cm]{media/robocup-header.png}}
...
\title{\vspace{-5ex}RoboCupJunior Rescue Line Rules 2019\vspace{-5ex}}
\date{\vspace{-2ex}}
...
\begin{tabular}{lr}
    \multicolumn{2}{l}{\textbf{Rescue Technical Committee 2019:}}\\
...
\resizebox{0.50\textwidth}{!}{
\begin{tabular}{lr}
    \multicolumn{2}{l}{\textbf{Rescue Technical Committee 2018:}}\\
    Naomi Chikuma               & Japan (CHAIR)\\
    Josie Hughes                & UK (Co-Chair)\\
    Phil Wade                   & Germany\\
    Jiayao Shen                 & Singapore \\
    Julia Maurer                & USA\\
    Barbara Correia             & Portugal\\
    Kai Junge                   & UKs\\
    Javier Gerardo Zetina Rosas & Mexico\\
\end{tabular}}
